...
- The demo access token is not granted the Databricks `files` scope, so the
  Files API upload of the fixture into the landing volume fails with
  `403 ... Provided access token does not have required scopes: files`. The
...
```json
{
  ...
  "archive_rows_with_missing_payload_or_provenance": 0,
...
```json
{
  ...
  "rerun_url": "https://dbc-8bc9474f-40ae.cloud.databricks.com/?o=7474651138173478#job/1044169125682053/run/830748977488604",
...
_Generated by `scripts/tp_databricks/recon_audit_archive.py` at 2026-08-15T22:47:24Z._
