...
CREATE TABLE IF NOT EXISTS bronze.search_documents_raw (
...
CREATE TABLE IF NOT EXISTS silver.search_index_documents (
  ns STRING NOT NULL,
...
CREATE TABLE IF NOT EXISTS silver.search_index_documents_staging (
  ns STRING NOT NULL,
...
CREATE TABLE IF NOT EXISTS gold.search_reindex_summary (
  ns STRING NOT NULL,
  run_date DATE NOT NULL,
  entity_type STRING NOT NULL,
