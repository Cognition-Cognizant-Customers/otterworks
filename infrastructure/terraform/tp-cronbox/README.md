...
while a probe remains in DynamoDB or when full absence was first observed less
than 120 seconds before the nominal deadline; that case continues through the
remaining stream-batching grace period to allow a healthy archive to arrive,
